...
EPMCInputs = namedtuple('JoyStickZInputs', [
    'X',
    'A',
    'neglogp',
    'R',
...
EPMCOutputs = namedtuple('JoyStickZOutputs', [
    'self_fed_heads',
    'outer_fed_heads',
    'loss',
    'vars',
...
EPMCTrainableVariables = namedtuple('JoyStickZTrainableVariables', [
    'all_vars',
    'vf_vars',
    'pf_vars',
    'ob_stat',
...
EPMCLosses = namedtuple('JoyStickZLosses', [
    'total_reg_loss',
    'pg_loss',
    'value_loss',
    'entropy_loss',
...
class EMPCConfig(object):
    def __init__(self, ob_space, ac_space, **kwargs):
        ...
        self.append_hist_a = True
        self.playground_input = True
        ...
        self.nrollout = None
        self.rollout_len = 1
        self.hs_len = 64 * 3  # for separate pi and vf lstm, and z
        self.nlstm = 32
        self.z_len = 256
        self.z_len_llc = 32
