...
ZMLPInputs = namedtuple('ZMLPInputs', [
    'X',
    'A',
    'neglogp',
    'R',
...
ZMLPOutputs = namedtuple('ZMLPOutputs', [
    'self_fed_heads',
    'outer_fed_heads',
    'loss',
    'vars',
...
ZMLPTrainableVariables = namedtuple('ZMLPTrainableVariables', [
    'all_vars',
    'encoder_vars',
    'decoder_vars',
    'lstm_vars',
...
ZMLPLosses = namedtuple('ZMLPLosses', [
    'total_reg_loss',
    'pg_loss',
    'value_loss',
    'entropy_loss',
...
class ZMLPConfig(object):
    def __init__(self, ob_space, ac_space, **kwargs):
        ...
        self.nrollout = None
        self.rollout_len = 1
        self.hs_len = self.z_len = 64  # for z
